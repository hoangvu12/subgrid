...
window.translations.en = {
  ...
  importExport: {
    ...
    importFromCsv: "Import subscription list",
    csvList: "CSV file with your subscriptions",
  ...
  subImport: {
    title: "Import Subscription List",
    uploadHint: "Upload a CSV file with your subscriptions. We'll help you map the columns.",
    chooseFile: "Choose CSV file",
    dragDrop: "or drag and drop",
    tipTitle: "Tip: CSV format",
    tipContent: "Your CSV should have columns for name, price, and optionally billing cycle. We'll auto-detect most formats!",
    invalidCsv: "Invalid CSV file. Make sure it has headers and data rows.",
    foundRows: "Found",
    rowsMapColumns: "rows. Map the columns:",
    nameColumn: "Name Column",
    priceColumn: "Price / Amount Column",
    cycleColumn: "Cycle Column (Optional)",
    preview: "Preview",
    parseSubscriptions: "Parse Subscriptions",
    selectColumns: "Please select at least the Name and Price columns.",
    parsedCount: "Parsed",
    subscriptionsSelect: "subscriptions. Select which ones to add:",
    noValidSubs: "No valid subscriptions found",
    checkMapping: "Check your column mapping",
    addSelected: "Add Selected",
    addCount: "Add {{count}} Subscription",
    addCountPlural: "Add {{count}} Subscriptions",
    addedSuccess: "Added {{count}} subscription!",
