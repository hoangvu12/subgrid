...
window.translations.pt = {
  ...
  actions: {
    ...
    tryExample: "Testar com dados de exemplo",
    neverMissRenewal: "Nunca perca uma renovação"
  },
  ...
  settings: {
    ...
    language: "Idioma",
    country: "Região",
    countryHint: "Altera os preços predefinidos para preços locais"
  },
  ...
  hero: {
    headline: "Veja para onde vai seu dinheiro",
    subheadline: "Visualize todas as suas assinaturas em uma grade bonita"
  },

  privacy: {
    badge: "Seus dados ficam no seu navegador"
  },

  country: {
    welcome: "Bem-vindo!",
    declineButton: "Não, manter USD",
    changeLater: "Você pode alterar isso depois nas Configurações"
  }
};
