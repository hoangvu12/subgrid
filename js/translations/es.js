...
window.translations.es = {
  ...
  actions: {
    ...
    neverMissRenewal: "No te pierdas una renovación"
  },
  ...
  settings: {
    ...
    language: "Idioma",
    country: "Región",
    countryHint: "Cambia los precios preestablecidos a precios locales"
  },
  ...
  hero: {
    ...
    subheadline: "Visualiza todas tus suscripciones en una cuadrícula elegante"
  },

  privacy: {
    badge: "Tus datos se quedan en tu navegador"
  },

  country: {
    welcome: "¡Bienvenido!",
    declineButton: "No, mantener USD",
    changeLater: "Puedes cambiarlo después en Configuración"
  }
};
